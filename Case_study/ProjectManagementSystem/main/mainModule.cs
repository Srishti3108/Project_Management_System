...
namespace ProjectManagementSystem.main
{
    internal class MainModule
    {
        ...
        private static void AddEmployee(IProjectRepository repository)
        {
            ...
            Console.WriteLine(result ? "....You Successfully added the Employee...." : "Error adding employee.");
        }
        ...
        private static void AddProject(IProjectRepository repository)
        {
            ...
            Console.WriteLine(result ? "....You successfully added Project...." : "Error adding project.");
        }
        ...
        private static void AddTask(IProjectRepository repository)
        {
            ...
            Console.WriteLine(result ? "....You sucessfully added the Task...." : "Error adding task.");
        }
        ...
        private static void AssignTaskToEmployee(IProjectRepository repository)
        {
            ...
            Console.WriteLine(result ? "... You successfully assigned Task to employee ..." : "Error assigning task.");
        }
