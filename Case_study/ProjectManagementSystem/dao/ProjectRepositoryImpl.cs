...
namespace ProjectManagementSystem.dao
{
    public class ProjectRepositoryImpl : IProjectRepository
    {
        ...
        {
            connectionString = ProjectManagementSystem.util.DBConnUtil.GetConnectionString();
        }
        ...
        public bool CreateTask(ProjectManagementSystem.entity.Task task) 
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
        ...
        public List<ProjectManagementSystem.entity.Task> GetAllTasksForEmployeeInProject(int employeeId, int projectId)
        {
            List<ProjectManagementSystem.entity.Task> tasks = new List<ProjectManagementSystem.entity.Task>();
            ...
            WHERE e.Id = @EmployeeId AND p.Id = @ProjectId";
                    ...
                    using (SqlCommand cmd = new SqlCommand(query, conn))
                    {
                        ...
                        using (SqlDataReader reader = cmd.ExecuteReader())
                        {
                            while (reader.Read())
                            {
                                ProjectManagementSystem.entity.Task task = new ProjectManagementSystem.entity.Task
                                {
